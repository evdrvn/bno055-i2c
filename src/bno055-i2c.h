...
extern int bno055_readquaternion(bno055_conn_t* conn, double data[4]);
extern int bno055_readeuler(bno055_conn_t* conn, double data[3]);
extern int bno055_readlinearaccel(bno055_conn_t* conn, double data[3]);
